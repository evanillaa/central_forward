...
Framework.Commands.Add("tp", "Teleport naar een Player of location", {{name="id/x", help="Player id or X Position"}, {name="y", help="Y Position"}, {name="z", help="Z Position"}}, false, function(source, args)
...
Framework.Commands.Add("addpermission", "Geef permissie aan iemand (god/admin)", {{name="id", help="Player id"}, {name="permission", help="Permission level"}}, true, function(source, args)
	local Player = Framework.Functions.GetPlayer(tonumber(args[1]))
...
Framework.Commands.Add("removepermission", "Haal permissie weg van iemand", {{name="id", help="Player id"}}, true, function(source, args)
	local Player = Framework.Functions.GetPlayer(tonumber(args[1]))
	if Player ~= nil then
...
Framework.Commands.Add("closenui", "Close nui", {}, false, function(source, args)
	TriggerClientEvent('qb-core:client:closenui', source)
end)

Framework.Commands.Add("opennui", "Open nui", {}, false, function(source, args)
	TriggerClientEvent('qb-core:client:opennui', source)
end)
...
Framework.Commands.Add("setmoney", "Zet het geld voor een Player", {{name="id", help="Player id"},{name="moneytype", help="What sort of money (cash, bank, crypto)"}, {name="amount", help="Amount"}}, true, function(source, args)
	local Player = Framework.Functions.GetPlayer(tonumber(args[1]))
	if Player ~= nil then
