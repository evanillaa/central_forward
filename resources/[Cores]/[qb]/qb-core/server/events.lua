...
AddEventHandler('playerDropped', function(reason) 
	...
	TriggerEvent("qb-logs:server:SendLog", "joinleave", "Dropped", "red", "**".. GetPlayerName(src) .. "** ("..GetPlayerIdentifiers(src)[1]..") left..")
...
AddEventHandler('Framework:UpdatePlayer', function(data)
	...
	if Player ~= nil then
		...
		TriggerClientEvent("qb-hud:client:update:needs", source, newHunger, newThirst)
...
AddEventHandler('Framework:Server:SetMetaData', function(Meta, Data)
	...
	TriggerClientEvent("qb-hud:client:update:needs", source, Player.PlayerData.metadata["hunger"], Player.PlayerData.metadata["thirst"])
end)
...
AddEventHandler("DevMode", function()
    ...
    TriggerEvent("qb-log:server:CreateLog", "anticheat", "Opening devtools", "orange", "**".. GetPlayerName(src) .. " heeft geprobeert devtools te openen")
