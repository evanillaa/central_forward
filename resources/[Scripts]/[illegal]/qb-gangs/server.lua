...
Framework.Commands.Add("setgang", "Give a gang to a player.", {{name="id", help="Player ID"}, {name="gang", help="Gang name"}, {name="grade", help="Grade name"}}, true, function(source, args)
    local src = source
