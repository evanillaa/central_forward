...
RegisterNUICallback('openStash', function(data)
    ...
    TriggerEvent("qb-inventory:client:SetCurrentStash", "boss_" .. Framework.Functions.GetPlayerData().job.name)
    TriggerServerEvent("qb-inventory:server:OpenInventory", "stash", "boss_" .. Framework.Functions.GetPlayerData().job.name, {
        maxweight = 4000000,
        slots = 500,
    })
