...
AddEventHandler('qb-burgershot:client:bake:fries', function()
  Framework.Functions.TriggerCallback('Framework:HasItem', function(HasItem)
    if HasItem then
      ...
      Framework.Functions.Notify("You miss pattatekes..", "error")
    end
  end, 'burger-potato')
end)
...
function MakeBurger(BurgerName)
  Citizen.SetTimeout(750, function()
    ...
    Framework.Functions.Progressbar("open-brick", "Hamburger Making..", 7500, false, true, {
...
function MakeFries()
  ...
  Framework.Functions.Progressbar("open-brick", "Baking fries.", 6500, false, true, {
      disableMovement = true,
      disableCarMovement = false,
      disableMouse = false,
      disableCombat = true,
...
function MakePatty()
  ...
  exports['qb-assets']:RequestAnimationDict("amb@prop_human_bbq@male@base")
  TaskPlayAnim(PlayerPedId(), "amb@prop_human_bbq@male@base", "base" ,3.0, 3.0, -1, 8, 0, false, false, false)
  Framework.Functions.Progressbar("open-brick", "Burger Baking..", 6500, false, true, {
      disableMovement = true,
      disableCarMovement = false,
      disableMouse = false,
      disableCombat = true,
...
function MakeDrink(DrinkName)
  ...
  Framework.Functions.Progressbar("open-brick", "Drink Tapping..", 6500, false, true, {
      disableMovement = true,
      disableCarMovement = false,
      disableMouse = false,
      disableCombat = true,
...
function CheckDuty()
  if Framework.Functions.GetPlayerData().job.name =='burger' and Framework.Functions.GetPlayerData().job.onduty then
     ...
     Framework.Functions.Notify("You're too late from work while clocked in!", "error")
  end
end
