...
AddEventHandler('qb-pig:getNewPig', function()
    ...
    local pick = ''
      ...
      if TriggerClientEvent('DoShortHudText', src, "You Received 3 Alive pig!") then
          ...
          TriggerClientEvent("inventory:client:ItemBox", source, Framework.Shared.Items['alivepig'], "add")
      end
end)
...
AddEventHandler('qb-pig:getcutPig', function()
    ...
    local pick = ''
      ...
      if TriggerClientEvent('DoShortHudText', src, "Well! You slaughtered pig.") then
          ...
          TriggerClientEvent("inventory:client:ItemBox", source, Framework.Shared.Items['alivepig'], "remove")
          TriggerClientEvent("inventory:client:ItemBox", source, Framework.Shared.Items['slaughteredpig'], "add")
      end
end)
...
AddEventHandler('qb-pig:getpackedPig', function()
    ...
    local pick = ''
      ...
      if TriggerClientEvent('DoShortHudText', src, "You Packed Slaughtered pig .") then
          ...
          TriggerClientEvent("inventory:client:ItemBox", source, Framework.Shared.Items['slaughteredpig'], "remove")
          TriggerClientEvent("inventory:client:ItemBox", source, Framework.Shared.Items['packagedpig'], "add")
      end
end)
...
AddEventHandler('qb-pig:getNewBeef', function()
    ...
    local pick = ''
      ...
      if TriggerClientEvent('DoShortHudText', src, "You Received 3 Alive cow!") then
          ...
          TriggerClientEvent("inventory:client:ItemBox", source, Framework.Shared.Items['alivecow'], "add")
      end
end)
...
AddEventHandler('qb-pig:getcutBeef', function()
    ...
    local pick = ''
      ...
      if TriggerClientEvent('DoShortHudText', src, "Well! You slaughtered beef.") then
          ...
          TriggerClientEvent("inventory:client:ItemBox", source, Framework.Shared.Items['alivecow'], "remove")
          TriggerClientEvent("inventory:client:ItemBox", source, Framework.Shared.Items['slaughteredbeef'], "add")
      end
end)
...
AddEventHandler('qb-pig:getpackedBeef', function()
    ...
    local pick = ''
      ...
      if TriggerClientEvent('DoShortHudText', src, "You Packed Slaughtered beef .") then
          ...
          TriggerClientEvent("inventory:client:ItemBox", source, Framework.Shared.Items['slaughteredbeef'], "remove")
          TriggerClientEvent("inventory:client:ItemBox", source, Framework.Shared.Items['packagedbeef'], "add")
      end
end)
