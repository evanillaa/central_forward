                    ...
                    if distance < 1.5 then
                        if InVehicle then
                            ...
                            if IsControlJustReleased(0, Keys["E"]) then
                                Framework.Functions.TriggerCallback('qb-garbagejob:server:CheckBail', function(DidBail)
                                    if DidBail then
                                        BringBackCar()
                                        Framework.Functions.Notify("You have received a $1000 deposit back!", "success")
                                    else
                                        Framework.Functions.Notify("You have not paid a deposit on this vehicle ..", "error")
                                    end
                                end)
                            end
                        else
                            ...
                            if IsControlJustReleased(0, Keys["E"]) then
                                Framework.Functions.TriggerCallback('qb-garbagejob:server:HasMoney', function(HasMoney)
                                    if HasMoney then
                                        ...
                                        Framework.Functions.SpawnVehicle("trash2", function(veh)
                                            ...
                                            IsWorking = true
                                            SetGarbageRoute()
                                            Framework.Functions.Notify("You have paid $1000!", "success")
                                            Framework.Functions.Notify("You have started working, location is indicated on your GPS!", "success")
                                        end, coords, true)
                                    else
                                        Framework.Functions.Notify("You do not have enough money for the deposit .. Deposit costs are $ 1000, -", "error")
                                    end
                                end)
                            end
                        end
                                            ...
                                            if IsControlJustPressed(0, 51) then
                                                ...
                                                if (AmountOfBags - 1) == 0 then
                                                    ...
                                                    if currentRuns <= 2 then
                                                        SetGarbageRoute()
                                                        Framework.Functions.Notify("All garbage bags are done, move on to the next location!", "success")
                                                    else
                                                        Framework.Functions.Notify("You are done working! Go back to the dump.", "success")
                                                    ...
                                                    if AmountOfBags > 1 then
                                                        Framework.Functions.Notify("There are still "..AmountOfBags.." bags left!",  "success")
                                                    else
                                                        Framework.Functions.Notify("There is still "..AmountOfBags.." bag left!",  "success")
                                                    end
                                                    hasZak = false
                                                end
                                                DeliverAnim()
