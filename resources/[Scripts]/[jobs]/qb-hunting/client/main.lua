...
function SlaughterAnimal(AnimalId)
    ...
    Framework.Functions.Notify('You skinned an animal. Weight: ' ..AnimalWeight.. 'kg')
...
function SellMeat()
    Framework.Functions.TriggerCallback('qb-hunting:server:has:meat', function(HasMeat)
        if HasMeat then
			Framework.Functions.Progressbar("selling-meat", "Selling meat..", 15000, false, true, {
			...
			Framework.Functions.Notify("You have no meat to sell..", "error", 2500)
        end
    end)
end