...
Citizen.CreateThread(function()
	...
	DrawText3D2(procesX, procesY, procesZ+0.1, "[E] Slice wood")
		...
		Framework.Functions.Notify('You dont have any planks.', 'error')
		end
		end	
	end
...
function SellKurczaki22()
    ...
    if(count == 0) then
    Framework.Functions.Progressbar("search_register", "Slicing wood..", 5000, false, true, {disableMovement = true,
...
function SellKurczaki()
    ...
    ----
    if(count == 0) then
    Framework.Functions.Progressbar("search_register", "Selling..", 5000, false, true, {disableMovement = true,
                        disableCarMovement = true,
                        disableMouse = false,
                        disableCombat = true,
                        disableInventory = true,
        ...
        if dist <= 1.0 then
		    ...
		    if GetPedInVehicleSeat(vehicled, -1) == PlayerPedId() then
				...
				local s1 = false
                    ...
                    Framework.Functions.Progressbar("search_register", "Insert code card..", 7000, false, true, {
