                ...
                if seat == ped then
                    if not CheckDone then
                        if vehiclemeters == -1 then
                            CheckDone = true
                            Framework.Functions.TriggerCallback('qb-vehicletuning:server:IsVehicleOwned', function(IsOwned)
                                if IsOwned then
                ...
                if vehiclemeters ~= -1 then
                    if seat == ped then
                        if previousvehiclepos ~= nil then
                            ...
                            if DamageKey ~= nil then
                                ...
                                if chance == odd then
                                    for k, v in pairs(Config.Damages) do
                                        ...
                                        Framework.Functions.TriggerCallback('qb-vehicletuning:server:SetPartLevel', function(result)
                            ...
                            Framework.Functions.TriggerCallback('qb-vehicletuning:server:UpdateDrivingDistance', function(result)
