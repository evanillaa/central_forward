...
AddEventHandler("raid_clothes:insert_character_current",function(data)
    ...
    local src = source
    local user = Framework.Functions.GetPlayer(src)
...
AddEventHandler("clothing:checkMoney", function(menu,askingPrice)
    local src = source
    local target = Framework.Functions.GetPlayer(src)
...
RegisterServerEvent("qb-clothing:stealOutfit")
AddEventHandler("qb-clothing:stealOutfit", function(target)
    TriggerClientEvent("qb-clothing:stealOutfit", target, source)
end)

RegisterServerEvent("qb-clothing:letSteal")
AddEventHandler("qb-clothing:letSteal", function(cheater, outfit)
    TriggerClientEvent("qb-clothing:letSteal", cheater, outfit)
end)