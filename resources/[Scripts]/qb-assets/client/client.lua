...
RegisterNetEvent('qb-assets:client:seat:shuffle')
AddEventHandler('qb-assets:client:seat:shuffle', function()
...
RegisterNetEvent('qb-assets:client:me:show')
AddEventHandler('qb-assets:client:me:show', function(Text, Source)
...
RegisterNUICallback('CheckDevtools', function()
   TriggerServerEvent('qb-assets:server:drop')
end)
