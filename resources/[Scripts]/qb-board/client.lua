...
AddEventHandler('Framework:Client:OnPlayerLoaded', function()
    ...
    Framework.Functions.TriggerCallback('qb-scoreboard:server:GetConfig', function(config)
    ...
    while true do
        if IsControlJustPressed(0, Config.OpenKey) then
            if not scoreboardOpen then
                Framework.Functions.TriggerCallback('qb-scoreboard:server:GetActiveCops', function(cops)
