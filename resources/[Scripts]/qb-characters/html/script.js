    ...
    window.addEventListener('message', function (event) {
        ...
        if (data.action == "ui") {
            if (data.toggle) {
                ...
                $.post('http://qb-characters/setupCharacters');
                $.post('http://qb-characters/removeBlur');
...
$(document).on('click', '.character-box', function(e) {
    ...
    if (selectedChar === null) {
        ...
        if ((selectedChar).data('cid') == "") {
            ...
            $.post('http://qb-characters/cDataPed', JSON.stringify({
                cData: cDataPed
            }));
        } else {
            $(selectedChar).addClass("selected");
...
$(document).on('click', '#create-user', function(e){
    e.preventDefault();
    $.post('http://qb-characters/createNewCharacter', JSON.stringify({
...
$(document).on('click', '#accept-delete', function(e){
    $.post('http://qb-characters/removeCharacter', JSON.stringify({
...
$(document).on('click', '#play', function(e) {
    ...
    if (selectedChar !== null) {
        if (charData !== "") {
            $.post('http://qb-characters/selectCharacter', JSON.stringify({
