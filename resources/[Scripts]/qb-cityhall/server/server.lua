...
AddEventHandler('qb-cityhall:server:requestId', function(identityData)
    ...
    TriggerClientEvent('qb-inventory:client:ItemBox', src, Framework.Shared.Items[identityData.item], 'add')
end)
...
AddEventHandler('qb-cityhall:server:ApplyJob', function(job)
    ...
    TriggerClientEvent('Framework:Notify', src, 'Congratulations with your new job as '..JobInfo.label..' !')
end)