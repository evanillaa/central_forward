...
local function drawButton(text, subText)
	...
	if multiplier then
		local y = menus[currentMenu].y + titleHeight + buttonHeight + (buttonHeight * multiplier) - buttonHeight / 0.67
...
function WarMenu.CreateMenu(id, title)
	...
	menus[id].subTitle = 'Menu Options'
	...
	menus[id].menuBackgroundColor = { r = 43, g = 43, b = 43, a = 160 }

	menus[id].subTitleBackgroundColor = { r = 43, g = 43, b = 43, a = 255 }
