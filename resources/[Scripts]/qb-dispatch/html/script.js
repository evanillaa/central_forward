...
function forwardCall(num) {
  ...
  for (const [key, value] of Object.entries(jobInfo)) {
    if (value.column == num) {
      $.post('https://qb-dispatch/forwardCall', JSON.stringify({
...
function copyNumber() {
  ...
  $.post('https://qb-dispatch/copynumber', JSON.stringify({}));
}

function toggleOffduty() {

  $.post('https://qb-dispatch/toggleoffduty', JSON.stringify({}));

}

function togglecallblips() {
  $.post('https://qb-dispatch/togglecallblips', JSON.stringify({}));
}

function toggleUnitBlips() {
  $.post('https://qb-dispatch/toggleunitblips', JSON.stringify({}));
}

function toggleAlerts() {

  $.post('https://qb-dispatch/togglealerts', JSON.stringify({}));

}

function changeToBusy() {
  $.post('https://qb-dispatch/updatestatus', JSON.stringify({
    id: id,
    status: 'Busy'
  }));
}
...
function dismissCall() {
  ...
  acceptedCall = '';
  $.post('https://qb-dispatch/dismissCall', JSON.stringify({
    id: currentElement.id
  }));
...
function removeCall() {
  ...
  $.post('https://qb-dispatch/removeCall', JSON.stringify({
    id: currentElement.id
  }));
...
function acceptCall() {
  ...
  $.post('https://qb-dispatch/acceptCall', JSON.stringify({
    id: currentElement.id,
  ...
  $.post('https://qb-dispatch/sendnotice', JSON.stringify({
...
function requestBackup() {
  ...
  for (const [key, value] of Object.entries(jobInfo)) {
    if (value.column == col) {
      $.post('https://qb-dispatch/reqbackup', JSON.stringify({
        job: key,
