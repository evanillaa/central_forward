...
AddEventHandler('Framework:Client:OnPlayerLoaded', function()
 Citizen.SetTimeout(1000, function()
	 ...
	 Citizen.Wait(250)
	 Framework.Functions.TriggerCallback("qb-doorlock:server:get:config", function(config)
		Config = config
	end)
	Citizen.Wait(150)
	LoggedIn = true
...
function SetDoorLock(Door, key)
 ...
 SetTimeout(1000, function()
   ...
   TriggerServerEvent('qb-doorlock:server:updateState', key, Door['Locked'])
 end)
end
...
AddEventHandler('qb-doorlock:client:setState', function(Door, state)
...
RegisterNetEvent('qb-doorlock:client:toggle:locks')
AddEventHandler('qb-doorlock:client:toggle:locks', function()
	SetDoorLock(DoorValue, DoorKey)
end)