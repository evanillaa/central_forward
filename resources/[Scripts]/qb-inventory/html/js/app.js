...
function FormatItemInfo(itemData) {
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id-card") {
            ...
            $(".item-info-description").html('<p><strong>BSN: </strong><span>' + itemData.info.citizenid + '</span></p><p><strong>Firstname: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Lastname: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Date of birth: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>Gender: </strong><span>' + gender + '</span></p><p><strong>Nationality: </strong><span>' + itemData.info.nationality + '</span></p>');
        } else if (itemData.name == "drive-card") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Firstname: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Lastname: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Date of birth: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>Licenses: </strong><span>' + itemData.info.type + '</span></p>');
        } else if (itemData.name == "lawyerpass") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Pas-ID: </strong><span>' + itemData.info.id + '</span></p><p><strong>Firstname: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Lastname: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>BSN: </strong><span>' + itemData.info.citizenid + '</span></p>');
...
function handleDragDrop() {
    ...
    $(".item-slot").droppable({
        ...
        drop: function(event, ui) {
            ...
            $.post("http://qb-inventory/UpdateStash", JSON.stringify({}));
        },
    });
    ...
    $(".item-slot").click(function(event) {
        if (event.shiftKey) {
            ...
            $.post('http://qb-inventory/UseItemShiftClick', JSON.stringify({
                slot: itemData.slot
            }));
        } 
    });
