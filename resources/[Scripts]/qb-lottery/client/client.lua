...
Citizen.CreateThread(function()
	while true do
       ...
       if Gebied <= 1.1 then
           NearSelling = true
		 	     DrawText3D(Config.Location['Coords']['X'], Config.Location['Coords']['Y'], Config.Location['Coords']['Z'] + 0.15, '~g~E~s~ - Check Out Lottery Tickets')
               ...
               TriggerServerEvent('qb-lottery:server:sell:card')
		 	     end
		   end
...
RegisterNetEvent('qb-lottery:client:open:card')
AddEventHandler('qb-lottery:client:open:card', function(id, prize)
