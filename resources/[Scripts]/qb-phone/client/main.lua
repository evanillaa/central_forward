...
RegisterNUICallback("GetCurrentDrivers", function(data, cb)
    Framework.Functions.TriggerCallback('qb-phone:server:GetCurrentDrivers', function(drivers)
        cb(drivers)
    end)
end)
        ...
        if IsControlJustPressed(0, Config.OpenPhone) then
            if not PhoneData.isOpen then
                ...
                if not IsHandcuffed then
                    ...
                    Framework.Functions.Notify("Action impossible..", "error")
                end
            end
        end
        Citizen.Wait(3)
...
function OpenPhone()
   Framework.Functions.TriggerCallback('qb-phone:server:HasPhone', function(HasPhone)
       if HasPhone then
            ...
            Framework.Functions.Notify("You dont have a phone", "error")
        end
   end)
end
...
RegisterNUICallback('SharedLocation', function(data)
    ...
    SendNUIMessage({
        ...
        PhoneNotify = {
            title = "Whatsapp",
            text = "Location has been set to GPS!",
        ...
        if PhoneData.isOpen then
            if SenderNumber ~= PhoneData.PlayerData.charinfo.phone then
                ...
                SendNUIMessage({
                    ...
                    PhoneNotify = {
                        title = "Whatsapp",
                        text = "You cant send messages towards yourself",
                        icon = "fab fa-whatsapp",
                        color = "#25D366",
                        timeout = 4000,
                    },
            ...
            SendNUIMessage({
                ...
                NotifyData = {
                    title = "Whatsapp", 
                    content = "New message from"..IsNumberInContacts(SenderNumber).."!", 
                    icon = "fab fa-whatsapp", 
                    timeout = 3500, 
                    color = "#25D366",
                },
...
AddEventHandler('qb-phone:client:NewMailNotify', function(MailData)
    if PhoneData.isOpen then
        SendNUIMessage({
            ...
            PhoneNotify = {
                title = "Mail",
                text = "You recieved a new email from "..MailData.sender,
        ...
        SendNUIMessage({
            ...
            NotifyData = {
                title = "Mail", 
                content = "You recieved a new email from "..MailData.sender, 
                icon = "fas fa-envelope", 
                timeout = 3500, 
                color = "#ff002f",
            },
...
AddEventHandler('qb-phone:client:send:email:bought:vehicle', function(Plate)
    ...
    SetTimeout(math.random(4500, 8000), function()
        TriggerServerEvent('qb-phone:server:sendNewMail', {
            ...
            message = "Dear " .. Player.charinfo.firstname .. " " .. Player.charinfo.lastname .. ",<br /><br />You are the new owner of a vehicle holding this plate number: <b>" .. Plate .. "</b>, happy safe miles!<br /><br />Kind regards,<br />Autoscout24",
            button = {}
        })
    end)
end)
...
AddEventHandler('qb-phone:client:send:email:sold:vehicle', function(SellPrice, VehiclePlate)
    SetTimeout(math.random(4500, 8000), function()
        TriggerServerEvent('qb-phone:server:sendNewMail', {
            ...
            message = "Dear reader,<br/><br/>We have good news!<br><br>Licenseplate: <strong>" ..VehiclePlate.. "</strong> <br>Price: <strong>€"..SellPrice.. '</strong><br><br>Your vehicle has been sold the money should be in your bank account.<br><br>Kind regards,<br>Autoscout24',
            button = {}
        })
    end)
end)
                ...
                if Firstname ~= PhoneData.PlayerData.charinfo.firstname and Lastname ~= PhoneData.PlayerData.charinfo.lastname then
                    ...
                    SetTimeout(2500, function()
                        SendNUIMessage({
                            ...
                            PhoneNotify = {
                                title = "Twitter", 
                                text = "You cant mention yourself!", 
                                icon = "fab fa-twitter",
                                color = "#1DA1F2",
                            },
                        })
...
AddEventHandler('qb-phone:client:NotEnoughBits', function(amount, newmoney)
    SendNUIMessage({
        ...
        PhoneNotify = {
            title = "Twitter", 
            text = "You dont have enough bits to post anonymous", 
            icon = "fab fa-twitter",
            color = "#1DA1F2",
        },
    })
...
AddEventHandler('qb-phone:client:TransferMoney', function(amount, newmoney)
    ...
    if PhoneData.isOpen then
        SendNUIMessage({ action = "PhoneNotification", PhoneNotify = { title = "Bank", text = "+ €"..amount.." added funds!", icon = "fas fa-university", color = "#8c7ae6", }, })
        SendNUIMessage({ action = "UpdateBank", NewBalance = PhoneData.PlayerData.money.bank })
    else
        SendNUIMessage({ action = "Notification", NotifyData = { title = "Bank", content = "+ €"..amount.." added funds!", icon = "fas fa-university", timeout = 2500, color = nil, }, })
    end
end)
    ...
    if PhoneData ~= nil and PhoneData.PlayerData ~= nil then
      local MyPlayerId = PhoneData.PlayerData.source
       if src ~= MyPlayerId then
          local titel = "Nieuwe Tweet (@"..NewTweetData.firstName.." "..NewTweetData.lastName..")"
              if not PhoneData.isOpen then
                  SendNUIMessage({
                      action = "Notification",
                      NotifyData = {
          ...
          SendNUIMessage({
              ...
              PhoneNotify = {
                  title = "Twitter", 
                  text = "Posted the tweet into the world!", 
                  icon = "fab fa-twitter",
                  color = "#1DA1F2",
                  timeout = 1000,
              },
...
AddEventHandler('qb-phone:client:GetMentioned', function(TweetMessage, AppAlerts)
    ...
    if not PhoneData.isOpen then
        SendNUIMessage({ action = "Notification", NotifyData = { title = "You are mentioned in a tweet", content = TweetMessage.message, icon = "fab fa-twitter", timeout = 3500, color = nil, }, })
    else
...
RegisterNUICallback('SetAlertWaypoint', function(data)
    ...
    Framework.Functions.Notify('GPS Location has been set to: '..data.alert.title)
...
AddEventHandler('qb-phone:client:GiveContactDetails', function()
    ...
    if player ~= -1 and distance < 2.5 then
        ...
        Framework.Functions.Notify("Nobody close!", "error")
    end
end)
...
AddEventHandler('qb-phone:client:AddNewSuggestion', function(SuggestionData)
    ...
    if PhoneData.isOpen then
        SendNUIMessage({
            ...
            PhoneNotify = {
                title = "Phone",
                text = "You have recieved a new shared contact", 
                icon = "fa fa-phone-alt",
                color = "#04b543",
                timeout = 1500,
            },
        ...
        SendNUIMessage({
            ...
            NotifyData = {
                title = "Phone", 
                content = "You have recieved a new shared contact", 
                icon = "fa fa-phone-alt", 
                timeout = 3500, 
                color = "#04b543",
            },
...
AddEventHandler('qb-phone:client:RemoveBankMoney', function(amount)
    if PhoneData.isOpen then
        SendNUIMessage({
            ...
            PhoneNotify = {
                title = "Bank",
                text = "€"..amount..",- has been taken from your bank!", 
                icon = "fas fa-university", 
                color = "#ff002f",
                timeout = 3500,
            },
        ...
        SendNUIMessage({
            ...
            NotifyData = {
                title = "Bank",
                content = "€"..amount..",- has been taken from your bank!", 
                icon = "fas fa-university",
                timeout = 3500, 
                color = "#ff002f",
            },
...
RegisterNUICallback('SetHouseLocation', function(data, cb)
    ...
    Framework.Functions.Notify("Your GPS location has been set " .. data.HouseData.HouseData['Adres'] .. "!", "info")
end)
...
RegisterNUICallback('SetGPSLocation', function(data, cb)
    ...
    Framework.Functions.Notify('GPS location has been set!', 'success')
end)
...
RegisterNUICallback('GetAvailableRaces', function(data, cb)
    ...
    Framework.Functions.TriggerCallback('qb-lapraces:server:GetRaces', function(Races)
        cb(Races)
    end)
end)
...
RegisterNUICallback('GetRaces', function(data, cb)
    Framework.Functions.TriggerCallback('qb-lapraces:server:GetListedRaces', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('GetTrackData', function(data, cb)
    Framework.Functions.TriggerCallback('qb-lapraces:server:GetTrackData', function(TrackData, CreatorData)
...
RegisterNUICallback('HasCreatedRace', function(data, cb)
    Framework.Functions.TriggerCallback('qb-lapraces:server:HasCreatedRace', function(HasCreated)
        cb(HasCreated)
    end)
end)
...
RegisterNUICallback('IsAuthorizedToCreateRaces', function(data, cb)
    Framework.Functions.TriggerCallback('qb-lapraces:server:IsAuthorizedToCreateRaces', function(IsAuthorized, NameAvailable)
        local data = {
...
RegisterNUICallback('GetRacingLeaderboards', function(data, cb)
    Framework.Functions.TriggerCallback('qb-lapraces:server:GetRacingLeaderboards', function(Races)
        cb(Races)
    end)
end)

RegisterNUICallback('RaceDistanceCheck', function(data, cb)
    Framework.Functions.TriggerCallback('qb-lapraces:server:GetRacingData', function(RaceData)
        local ped = PlayerPedId()
        ...
        if dist <= 115.0 then
            ...
            Framework.Functions.Notify('You are too far from the race. Your navigation is set to the race.', 'error', 5000)
...
RegisterNUICallback('CanRaceSetup', function(data, cb)
    Framework.Functions.TriggerCallback('qb-lapraces:server:CanRaceSetup', function(CanSetup)
