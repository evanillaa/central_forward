SetupLawyers = function(data) {
    ...
    if (data.length > 0) {
        ...
        $(".lawyers-list").append('<br><h1 style="font-size:16px; padding:10px; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(155, 15, 120);">Realestate ('+realestate.length+')</h1>');
        ...
        if (realestate.length > 0) {            
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">There is no broker available.</div></div>'
            $(".lawyers-list").append(element);
        }
        ...
        if (mechanic.length > 0) {            
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">There is no mechanics available.</div></div>'
            $(".lawyers-list").append(element);
        }
    }
                ...
                if (status.CanCall) {
                    if (!status.InCall) {
                        if (QB.Phone.Data.AnonymousCall) {
                            QB.Phone.Notifications.Add("fas fa-phone", "Telephone", "You have started an anonymous call!");
                        }
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "Telephone", "You are already busy");
                    }
                } else {
                    QB.Phone.Notifications.Add("fas fa-phone", "Telephone", "This person is already in call!");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Telephone", "Not available");
            }
        } else {
            QB.Phone.Notifications.Add("fas fa-phone", "Telephone", "You cant call yourself!");
        }
    });
});