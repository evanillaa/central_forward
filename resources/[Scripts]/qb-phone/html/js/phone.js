                ...
                if (status.CanCall) {
                    if (!status.InCall) {
                        if (QB.Phone.Data.AnonymousCall) {
                            QB.Phone.Notifications.Add("fas fa-phone", "Telefoon", "You have initiated an anonymous call!");
                        }
...
//         if (!QB.Phone.Data.CallActive) {
//             $(".call-notifications-title").html("Incoming Call");
//             $(".call-notifications-content").html("Je hebt een Incoming Call van "+CallData.name);
//             $(".call-notifications").css({"display":"block"});
//             $(".call-notifications").animate({
//                 right: 5+"vh"
//             }, 400);
