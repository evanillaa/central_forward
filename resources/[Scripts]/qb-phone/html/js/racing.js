    ...
    $.post('http://qb-phone/IsAuthorizedToCreateRaces', JSON.stringify({}), function(data){
        if (data.IsAuthorized) {
            if (!data.IsBusy) {
                ...
                QB.Phone.Notifications.Add("fas fa-flag-checkered", "Racing", "You are already making a Track..", "#1DA1F2");
            }
        } else {
            QB.Phone.Notifications.Add("fas fa-flag-checkered", "Racing", "You have no rights to create Race Track's..", "#1DA1F2");
        }
    });
});
