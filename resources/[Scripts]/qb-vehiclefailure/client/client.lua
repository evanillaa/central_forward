...
RegisterNetEvent('qb-vehiclefailure:client:fix:veh')
AddEventHandler('qb-vehiclefailure:client:fix:veh', function()
	if IsPedSittingInAnyVehicle(PlayerPedId()) then
		...
		SetVehicleFuelLevel(Vehicle, Amount + 0.0)
 		TriggerServerEvent('qb-fuel:server:update:fuel', vehiclePlate, Vehicle, math.floor(Amount))
	else
