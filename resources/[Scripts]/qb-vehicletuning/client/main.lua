                    ...
                    if StashDistance < 20 then
                        ...
                        if StashDistance < 1 then
                            ...
                            if IsControlJustReleased(0, Keys["E"]) then
                                TriggerEvent("qb-inventory:client:SetCurrentStash", "mechanicstash")
                                TriggerServerEvent("qb-inventory:server:OpenInventory", "stash", "mechanicstash", {
                                    maxweight = 4000000,
                                    slots = 500,
                                })
                            end
...
function SpawnListVehicle(model)
    ...
    Framework.Functions.SpawnVehicle(model, function(veh)
        ...
        exports['qb-fuel']:SetFuelLevel(Vehicle, GetVehicleNumberPlateText(veh), 100, false)
        Menu.hidden = true
